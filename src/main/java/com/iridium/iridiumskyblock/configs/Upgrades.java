...
public class Upgrades {
        public Upgrade<SizeUpgrade> sizeUpgrade = new Upgrade<>(true, "Size",
                        ...
                        ImmutableMap.<Integer, SizeUpgrade>builder()
                                        .put(1, new SizeUpgrade(1000, 15, 50, null, "Anyone"))
                                        .put(2, new SizeUpgrade(1000, 15, 100, "group.rare", "Rare"))
                                        .put(3, new SizeUpgrade(1000, 15, 150, "group.legendary", "Legendary"))
                                        .build());
        ...
        public Upgrade<MemberUpgrade> memberUpgrade = new Upgrade<>(true, "Member",
                        ...
                        ImmutableMap.<Integer, MemberUpgrade>builder()
                                        ...
                                        .put(2, new MemberUpgrade(1000, 15, 18, "group.rare", "Rare"))
                                        .put(3, new MemberUpgrade(1000, 15, 27, "group.legendary", "Legendary"))
                                        .build());
        ...
        public Upgrade<WarpsUpgrade> warpsUpgrade = new Upgrade<>(true, "Warps",
                        ...
                        ImmutableMap.<Integer, WarpsUpgrade>builder()
                                        ...
                                        .put(2, new WarpsUpgrade(1000, 15, 2, "group.rare", "Rare"))
                                        .put(3, new WarpsUpgrade(1000, 15, 3, "group.rare", "Rare"))
                                        .put(4, new WarpsUpgrade(1000, 15, 4, "group.legendary", "Legendary"))
                                        .put(5, new WarpsUpgrade(1000, 15, 5, "group.legendary", "Legendary"))
                                        .build());

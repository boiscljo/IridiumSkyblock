...
public class TimedMissionsGUI extends PagedGUI<Map.Entry<String, Mission>> {
     ...
     */
    public TimedMissionsGUI(Player player, @NotNull Island island, Inventory previousInventory) {
        super(1,
                IridiumSkyblock.getInstance().getInventories().timedMissionGUI.size,
                IridiumSkyblock.getInstance().getInventories().timedMissionGUI.background,
    ...
    public Inventory getInventory() {
        NoItemGUI noItemGUI = IridiumSkyblock.getInstance().getInventories().timedMissionGUI;

...
/**
 * GUI which shows all items in a {@link BiomeCategory} and allows players to
 * purchase them.
 */
public class BiomeCategoryGUI extends GUI {
  ...
  public Inventory getInventory() {
    Inventory inventory = Bukkit.createInventory(this, category.size,
        StringUtils.color(IridiumSkyblock.getInstance().getBiomes().categoryTitle

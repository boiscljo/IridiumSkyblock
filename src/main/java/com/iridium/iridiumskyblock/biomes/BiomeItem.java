...
public class BiomeItem {
     ...
     */
    public BiomeItem(String name, String displayName, XBiome biome, ObsidianMaterial item, int defaultAmount, int slot, BuyCost buyCost) {
        this.name = name;

...
public class SetCommand extends Command {
     ...
     */
    public SetCommand() {
        super(Collections.singletonList("set"), "Set a players bank value",
                "%prefix% &7/is bank set <player> <type> <amount>", "iridiumskyblock.bank.set", false, Duration.ZERO);
    }
                ...
                if (island.isPresent()) {
                    ...
                    if (bankItem.isPresent()) {
                        try {
                            ...
                            sender.sendMessage(StringUtils.color(IridiumSkyblock.getInstance().getMessages().setBank

...
public class RecalculateCommand extends Command {
  ...
  public boolean execute(CommandSender sender, String[] args) {
    ...
    bukkitTask = Scheduler.getInstance().runTaskLater(new Runnable() {
        ...
        if (islands.hasNext()) {
          ...
          if (IridiumSkyblock.getInstance().getConfiguration().extraDebugMessage)
            IridiumSkyblock.getInstance().getLogger()
                .info("recalculation finished in " + (System.currentTimeMillis() - start) + " milliseconds");
